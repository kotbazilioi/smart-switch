...
if (FW_data.V_DHCP!=1)
{
  ...
  IP_ADDRESS[2] =  FW_data.V_IP_CONFIG[2];
  IP_ADDRESS[3] =  FW_data.V_IP_CONFIG[3];
  NETMASK_ADDRESS[0] = FW_data.V_IP_MASK[0];
  NETMASK_ADDRESS[1] = FW_data.V_IP_MASK[1];
  NETMASK_ADDRESS[2] = FW_data.V_IP_MASK[2];
  NETMASK_ADDRESS[3] = FW_data.V_IP_MASK[3];
  GATEWAY_ADDRESS[0] = FW_data.V_IP_GET[0];
